  ...
  return (
    <div className='w-full flex flex-col'>
        ...
        <div className='w-full px-[10px] lg:px-[100px] bg-white py-[20px] lg:py-[50px]'>
            ...
            <p className='mt-[20px] underline colRo'>Prohibited and restricted items</p>
            ...
            <p className='mt-[20px] underline colRo'>Rules and policies for buyers</p>
            ...
            <p className='mt-[20px] underline colRo'>Feedback policies</p>
