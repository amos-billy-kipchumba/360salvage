  ...
  return (
    <div className='AboutPum w-full flex flex-col'>
        ...
        <div className='flex flex-col bg-white w-full px-[10px] lg:px-[100px] py-[10px] lg:py-[50px]'>
            <h3 className='colRor'>Introduction</h3>
            ...
            <h2 className='colRor mt-[50px]'>What personal data do we use?</h2>
            ...
            <h3 className='colRor mt-[50px]'>What are the purposes of the processing of your personal data?</h3>
