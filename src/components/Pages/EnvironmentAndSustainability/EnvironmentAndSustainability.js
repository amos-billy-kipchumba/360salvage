  ...
  return (
    <div className='w-full flex flex-col'>
        <div className='w-full h-[25vh] lg:h-[20vh] md:h-[30vh] xl:h-[40vh] pb-8 flex flex-col justify-end bg-gray-100'>
            <div className='flex justify-between'>
                ...
                <h5 className='mr-[10px] md:mr-[100px] hidden md:flex align-middle text-xs'>
                    <span className='mr-2 text-gray-600'>YOU ARE HERE:</span>/ <span className='ml-1 text-green-400'>Environment & Sustainability</span>
                </h5>
            </div>
        </div>
        ...
        <div className='w-full px-[10px] lg:px-[100px] bg-white py-[20px] lg:py-[50px]'>
            ...
            <p className='mt-[20px] underline text-green-400'>Environmental Geology and Sustainability</p>
            ...
            <p className='mt-[20px] underline text-green-400'>Environmental Globalization and Sustainability Laws</p>
            ...
            <p className='mt-[20px] underline text-green-400'>Green Meetings: Environmental Impact and Sustainability</p>
