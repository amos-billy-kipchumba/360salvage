  ...
  return (
    <div className='w-full flex min-h-[60vh]'>
        ...
        <div className='min-h-[50vh] flex-1 overflow-hidden relative'>
            ...
            <div className='LetGo w-full min-h-full absolute top-0 left-0 flex flex-col px-[100px]'>
                ...
                <div className='flex w-[500px] border border-white mt-[50px] mb-[50px]'>
                ...
                <span className='flex text-white mx-[5px]'>Privacy Policy</span> | Opt out anytime</p>
            </div>
        </div>
    </div>
  )
